...
namespace EntityFrameworkNorthwind
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<EmployeesSaleReport_Result> EmployeesSaleReport(Nullable<System.DateTime> fromdate, Nullable<System.DateTime> todate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EmployeesSaleReport_Result>("EmployeesSaleReport", fromdateParameter, todateParameter);
        }
    
        public virtual ObjectResult<ProductWiseMonthlyReport_Result> ProductWiseMonthlyReport(string productname, string month, string year)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProductWiseMonthlyReport_Result>("ProductWiseMonthlyReport", productnameParameter, monthParameter, yearParameter);
        }
